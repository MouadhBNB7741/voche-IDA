...
export default function Notifications() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (updated) => {
      console.log("Updated prefs from backend:", updated); 
  ...
  const handleToggle = (key: string, value: boolean) => {
    ...
    console.log("Toggle key:", key, "value:", value);
    console.log("Current notificationTypes:", prefs.notificationTypes);
  ...
  const handleFrequencyChange = (frequency: "instant" | "daily" | "weekly") => {
    if (!prefs) return;
    mutation.mutate({ ...prefs, frequency });
  };
      ...
      {prefs && (
        <div className="space-y-4 mt-8">
          ...
          <Card className="p-6 border-border/60 shadow-sm space-y-4">
            <h4 className="font-semibold">Delivery Frequency</h4>
            <Select
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(val) => handleToggle("emailAlerts", val)}
          ...
          <Card className="p-6 border-border/60 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              {prefs.notificationTypes &&
                Object.entries(prefs.notificationTypes).map(([key, value]) => (
